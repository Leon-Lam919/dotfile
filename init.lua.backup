...
require('lazy').setup({
...

  {
    ...
    build = 'yarn install --frozen-lockfile && yarn build',
    config = function()
      -- Add any coc.nvim specific configuration here
      vim.g.coc_global_extensions = {

        'coc-json',
        'coc-tsserver',
        -- Add other coc extensions you want to install
      }
    end,
  },
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>ff', function()
        require('telescope.builtin').find_files {
          ...
          cwd = require('lspconfig').util.root_pattern '.git'(vim.fn.getcwd()) or vim.fn.getcwd(),
          hidden = true,
          follow = true,
        }
  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    config = function()
        ...
        jdtls = {
          settings = {
            java = {
              ...
              -- Enable more intelligent code completion
              completion = {
                importOrder = {
                  'java',
                  'javax',
              ...
              -- Enable more detailed code actions
              codeGeneration = {
                toString = {
              ...
              diagnostics = {
                -- Adjust sensitivity of diagnostics
                disabled = {},
          ...
          -- Additional capabilities for Java
          capabilities = {
            textDocument = {
              completion = {
                completionItem = {
      ...
      -- Extend ensure_installed to include Java-specific tools
      local ensure_installed = vim.tbl_keys(servers or {})
      vim.list_extend(ensure_installed, {
        'stylua', -- Existing tool
        -- Java-specific development tools
        'jdtls',
        'java-debug-adapter',
        'java-test',
        'lombok-lombok',
        ...
        handlers = {
          jdtls = function()
            ...
            require('lspconfig').jdtls.setup {
              ...
              -- Consider adding project-specific configuration loading
              -- This helps with multi-module projects
              on_attach = function(client, bufnr)
                -- Additional on-attach logic specific to Java
                -- For example, you might want to set up additional keymaps
  ...
  { -- You can easily change to a different colorscheme.
    ...
    init = function()
      ...
      -- Set transparent background for Neovim
      vim.cmd [[ 
